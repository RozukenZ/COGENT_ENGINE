...
// 1. SPHERE (Bola)
// ==========================================
void PrimitiveMesh::createSphere(float radius, int sectors, int stacks) {
...
// 3. TRIANGLE
// ==========================================
void PrimitiveMesh::createTriangle() {
    vertices.clear(); indices.clear();
    vertices.push_back({{-0.5f, -0.5f, 0.0f}, {1,1,1}, {0, 0, 1}, {0.0f, 1.0f}}); 
    vertices.push_back({{ 0.5f, -0.5f, 0.0f}, {1,1,1}, {0, 0, 1}, {1.0f, 1.0f}}); 
    vertices.push_back({{ 0.0f,  0.5f, 0.0f}, {1,1,1}, {0, 0, 1}, {0.5f, 0.0f}}); 
    indices = {0, 1, 2};
}
...
// 4. CYLINDER
// ==========================================
void PrimitiveMesh::createCylinder(float radius, float height, int segments) {
    vertices.clear(); indices.clear();
    ...
    for (int i = 0; i < segments; i++) {
        ...
        // Top Cap
        indices.push_back(topCenterIdx); indices.push_back(nextTop); indices.push_back(currentTop);
        // Bottom Cap
        indices.push_back(botCenterIdx); indices.push_back(currentBot); indices.push_back(nextBot);
    }
}
...
// 5. CAPSULE
// ==========================================
void PrimitiveMesh::createCapsule(float radius, float height, int sectors, int stacks) {
    vertices.clear(); indices.clear();
